...
for transaction in daily_transactions_split:
  ...
  for action in transaction:
    transactions.append(action.strip())
...
print("Total Sales: ${}".format(format(total_sales, '.2f')))
...
for color in thread_sold:
  ...
  if len(color_split) == 1:
    #print("{}: True".format(color_split))
    thread_sold_split.append(color_split[0])
  else:
    #print("{}: False".format(color_split)""
...
def color_count(color):
  counter = 0
  out_color = color
  for color2 in thread_sold_split:
    if color == color2:
      counter += 1
    else:
      continue
  return out_color, counter
#print(color_count('red'))
#color_count_stripped_1 = str(color_count).strip('(')
...
for color in colors: 
  color_2 = color_count(color)
  out_count = color_2[1]
  out_color = color_2[0]

  print("Total {} sold: {}".format(out_color, out_count))
